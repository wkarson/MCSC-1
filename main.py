...
cap = cv2.VideoCapture('nakawa_output.mp4')
input_size = 320
...
#If you are using a good graphics card, please uncomment the two lines below
...
def realTime():
    while True:
        ...
        img = cv2.resize(img, (0, 0), None, 3, 2.7)
